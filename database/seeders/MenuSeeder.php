    ...
    public function run()
    {
        ...
        $requests->push((object) [
            ...
            'childrens' => collect([
                ...
                (object) [ 'name' => 'Cash Flow', 'route' => 'clients.accounting.cash-flow', 'description' => 'cash_flow.labels.menu_info', 'function' => false, 'for_client' => true, 'icon' => 'fas fa-cash-register', 'lang' => 'cash_flow.labels.menu' ],
            ])
        ]);
        $requests->push((object) [
