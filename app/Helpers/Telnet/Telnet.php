...
class Telnet {
    ...
    private $buffer = NULL;
    private $prompt;
    private $welcome_prompt = "#";
    private $username_prompt = "Username:";
    private $password_prompt = "Password:";
    private $errno;
    private $errstr;
    ...
    {
        try {
            $this->setPrompt($this->username_prompt);
            $this->waitPrompt();
            $this->write($username);
            $this->setPrompt($this->password_prompt);
            $this->waitPrompt();
            $this->write($password);
            $this->setPrompt();
            $this->waitPrompt();
     ...
     * @return boolean
     */
    public function setPrompt($str = "") { // setPrompt($str = "$")
