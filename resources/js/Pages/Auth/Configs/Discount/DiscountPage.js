                                                            ...
                                                            <>
                                                                ...
                                                                <div className="dropdown-menu" role="menu">
                                                                    {this.state.privilege.update &&
                                                                        <button type="button" onClick={()=>this.toggleModal(item)} className="dropdown-item text-primary"><i className="fa fa-pen-alt mr-1"/> {Lang.get('discounts.update.btn')}</button>
                                                                    }
                                                                    {this.state.privilege.delete &&
...
root.render(<React.StrictMode><DiscountPage route="auth.configs.discounts"/></React.StrictMode>);
